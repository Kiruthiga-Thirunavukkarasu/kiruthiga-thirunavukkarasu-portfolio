...
function HeroCloudArt() {
  return (
    <div className="relative w-full max-w-md mx-auto">
      ...
      <div className="relative rounded-[2rem] border border-slate-200/70 dark:border-slate-700/70 bg-white/80 dark:bg-slate-900/80 p-3 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.35)] backdrop-blur">
        <img
          ...
          loading="eager"
        />
        <div className="absolute bottom-6 left-6 rounded-full bg-white/90 dark:bg-slate-900/90 px-4 py-2 shadow-lg border border-slate-200 dark:border-slate-700">
          <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#0078D4]">Cloud Networking</p>
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">AWS • Azure • Telecom</p>
        </div>
      </div>
      <div className="absolute -top-4 -left-4 w-4 h-4 bg-[#FF9900] rounded-full animate-pulse shadow-lg" />
      <div className="absolute -bottom-4 -right-4 w-5 h-5 bg-[#0078D4] rounded-full animate-pulse shadow-lg" style={{ animationDelay: "0.6s" }} />
    </div>
  );
}
      ...
      <section id="top" className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 relative grid md:grid-cols-2 gap-10 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="mt-4 text-sm font-medium text-[#0078D4]">Bridging telecom resilience with cloud-native innovation.</p>
